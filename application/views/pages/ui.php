                            ...
                            <div class="row secter" >
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="col-xs-4 col-sm-4 text-center">
                                                ...
                                                <a href="<?=base_url()?>index.php/Workers/profileimage" role="button" data-toggle="modal" title="Reset Profile Image">
                                                    <?php if($profileimage==NULL){; ?>
                                                    <img src="<?=base_url()?>assets/uploads/profile/avatarreal.png" alt="" class="center-block img-square img-thumbnail img-responsive">
                                                    <?php }else{; ?>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <?php echo @$msg?>
                                        <?php
                                        foreach($porInfo as $userportInfo):
                                        ?>
                                        <div class="col-md-12">
                                            <div class="panel panel-default">
                                                <div class="panel-body">
                                                    ...
                                                    <div>
                                                        <a href="<?=base_url()?>index.php/Workers/index/<?=$userportInfo['Id']?>" title="Delete Image" class="btn btn-default pull-right" onClick="return confirm('Do you want to delete this image? ') "><i class="fa fa-trash"></i></a>
                                                    </div>
